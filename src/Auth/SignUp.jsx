...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen px-6 py-4 flex flex-col items-center justify-between bg-white text-black font-sans">            
            {walletAddress ? (
                <WalletAddress setWalletAddress={setWalletAddress}/>
        ) : ( 
          ...
          <img src={Logo} alt="Logo" className="w-32 mt-5 inline-block" />
            ...
            <form className="w-full space-y-4">
                ...
                <button onClick={handleWalletAddress} className="w-full rounded-xl py-3 px-4 text-base leading-5  text-black font-normal cursor-pointer bg-gradient-to-r from-[var(--button-gradient-1)] to-[var(--button-gradient-2)]">Sign up</button>
